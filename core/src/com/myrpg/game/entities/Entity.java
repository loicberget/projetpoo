...
public class Entity {
    ...
    private void loadAllAnimations() {
        ...
        _walkAnimations.insert(DIRECTION_UP, createAnimationFromTx(_entitySpritePath, WALK_UP_ROW, WALK_NB_COLS, FRAME_WIDTH, FRAME_HEIGHT));
        _walkAnimations.insert(DIRECTION_LEFT, createAnimationFromTx(_entitySpritePath, WALK_LEFT_ROW, WALK_NB_COLS, FRAME_WIDTH, FRAME_HEIGHT));
        _walkAnimations.insert(DIRECTION_DOWN, createAnimationFromTx(_entitySpritePath, WALK_DOWN_ROW, WALK_NB_COLS, FRAME_WIDTH, FRAME_HEIGHT));
        _walkAnimations.insert(DIRECTION_RIGHT, createAnimationFromTx(_entitySpritePath, WALK_RIGHT_ROW, WALK_NB_COLS, FRAME_WIDTH, FRAME_HEIGHT));
    }
